...
\begin{figure}[H]
	...
	\endminipage
\end{figure}
\footnotetext{\url{https://goo.gl/QqycYK} (visited on 02.14.2018)
}
...
\footnotetext{\url{https://i.stack.imgur.com/t2mC3.png} (visited on 02.14.2018)}
...
\footnotetext{\url{https://goo.gl/KbqZDe} (visited on 02.14.2018)}
\setcounter{footnote}{4}
\footnotetext{\url{https://goo.gl/Kaqs45} (visited on 02.14.2018)}
